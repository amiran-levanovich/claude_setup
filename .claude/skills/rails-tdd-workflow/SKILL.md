...
description: Use when implementing any feature, bugfix, or refactor in a Rails project, or when the user says 'implement', 'build this feature', 'add this functionality', 'fix this bug', or 'refactor this'. Covers branching, the feature-scoped to-do list, the TDD cycle (test-first, commit failing tests, then implement), and the pre-commit verification gate.
---
