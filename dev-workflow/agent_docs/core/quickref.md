...
9. **Before the PR**: the review loop (style / security / DRY / N+1) over the full diff. Log every round in the feature doc's Review log; only a *logged* clean round ends the loop.
